...
//
// This program builds a musical instrument with multiple strings. Users can play sounds by either 
// typing notes on the keybord or doing different pitches to pluck the strings. It can get the 
// current sound sample from strings. 
...
public class Guitar37 implements Guitar {
   ...
   // post: construct a guitar of multiple strings with different frequencies. 
   public Guitar37() {
      time = 0;
   ...
   // pre: pitch is within the boundary (ignore pitches that out of range)
   // post: playing a note by passing this pitch  
   ...
   // post: pluck the string to play by passing this key
   ...
   // post: get all of the samples from the strings of this guitar
